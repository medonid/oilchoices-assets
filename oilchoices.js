/* ══════════════════════════════════════════════
   OILCHOICES.COM — Header JS v6 FINAL
   Fixed: regex, onclick, no defer needed
══════════════════════════════════════════════ */
(function(){
  'use strict';
  ...
  function init(){
    ...
    function onScroll(){
      ...
      D.documentElement.style.setProperty('--oc-nb-h',
        Math.round(nb.getBoundingClientRect().height)+'px');
      tick=false;
    }
